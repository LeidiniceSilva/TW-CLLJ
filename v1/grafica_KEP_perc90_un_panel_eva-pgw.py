...
path = '/home/netapp-clima-users/users/jsalinas/Sim_RegCM/KEP/percentil90' # Path
...
def import_data(exp):
	...
	ds = xr.open_dataset('{0}/ECP700_{1}.nc'.format(path, exp))
...
lats, lons, uwnd_jun_jul_80_17_eva = import_data('jun-jul-eva_perc90')
lats, lons, uwnd_ago_oct_80_17_eva = import_data('ago-oct-eva_perc90')
lats, lons, uwnd_jun_jul_80_17_pgw = import_data('jun-jul-pgw_perc90')
lats, lons, uwnd_ago_oct_80_17_pgw = import_data('ago-oct-pgw_perc90')
lats, lons, uwnd_jun_jul_diff = import_data('jun-jul-diff_perc90')
lats, lons, uwnd_ago_oct_diff = import_data('ago-oct-diff_perc90')
...
mp.contour(lon, lat, Z, levels=[8],colors='k', linewidths=0.4,linestyles='solid')
...
plt.savefig('figs/KEP-subplots-eva-pgw_perc90.png', dpi=400, bbox_inches='tight')
plt.show()
exit()
