...
# -------------------------------------------------------------
# Row 1: Jet Core (Jun-Jul & Aug-Oct)
# -------------------------------------------------------------
...
# -------------------------------------------------------------
# Row 2: Jet Exit (Jun-Jul & Aug-Oct)
# -------------------------------------------------------------
...
ax[1, 0].set_xlabel('Temperature at 925 hPa (°C) - Active years')
...
ax[1, 1].set_xlabel('Temperature at 925 hPa (°C) - Active years')
ax[1, 1].grid(ls='--', alpha=0.4)
ax[1, 1].legend()

plt.tight_layout()
plt.savefig('figs/ta925_PDFs-eva-pgw-ERA5_core_exit_2x2.png', dpi=400, bbox_inches='tight')
plt.show()
exit()
