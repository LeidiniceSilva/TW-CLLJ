...
path = '/home/netapp-clima-users/users/jsalinas/Sim_RegCM/wavelets/vorticity' # Path
...
# Define "Core": (13.5, 16,  -71, -76),
lat_min, lat_max = 13, 16
lon_min, lon_max = -76, -71
...
plt.savefig(
    "wavelets_vorti_clim_core_eva.png",
    dpi=300,
    bbox_inches="tight"
)
