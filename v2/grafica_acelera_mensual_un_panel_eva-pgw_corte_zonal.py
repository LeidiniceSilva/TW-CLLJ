...
__description__ = "This script plot zonal mean acceleration at 925 hPa"
...
plt.savefig('figs/aacelera-corte-zonal-subplots-eva_pgw.png', dpi=400, bbox_inches='tight')
plt.show()
exit()
