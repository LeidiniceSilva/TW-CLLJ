...
path = '/home/netapp-clima-users/users/jsalinas/Sim_RegCM/grad_geopot' # Path
...
def import_data(exp):
        ds = xr.open_dataset('{0}/prom-zg925_grad_meridional-{1}.nc'.format(path, exp))
	# print(ds)
...
plt.ylabel('Zonal geopotential gradient')
plt.title('grad_zonal_geopot_12.5°N–17.5°N at 925 hPa')
plt.grid()
...
plt.savefig('figs/gradiente-geopot-term-corte-zonal-subplots-eva_pgw.png', dpi=400, bbox_inches='tight')
plt.show()
exit()
