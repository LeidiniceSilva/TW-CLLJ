...
c_scheme = mp.pcolor(x,y,np.squeeze(uwnd_jun_jul_80_17_act[0,:,:]), cmap='Blues_r', vmin=mi, vmax=md) # [0,:,:] is for the first day of the year
mp.contour(x, y,np.squeeze(uwnd_jun_jul_80_17_act[0, :, :]), levels=[-9],colors='k', linewidths=0.4,linestyles='solid')
...
c_scheme = mp.pcolor(x,y,np.squeeze(uwnd_jun_jul_82_16_ina[0,:,:]), cmap='Blues_r', vmin=mi, vmax=md) # [0,:,:] is for the first day of the year
mp.contour(x, y,np.squeeze(uwnd_jun_jul_82_16_ina[0, :, :]), levels=[-9],colors='k', linewidths=0.4,linestyles='solid')
...
c_scheme = mp.pcolor(x,y,np.squeeze(uwnd_ago_oct_80_17_act[0,:,:]), cmap='Blues_r', vmin=mi, vmax=md) # [0,:,:] is for the first day of the year
mp.contour(x, y,np.squeeze(uwnd_ago_oct_80_17_act[0, :, :]), levels=[-9],colors='k', linewidths=0.4,linestyles='solid')
...
c_scheme = mp.pcolor(x,y,np.squeeze(uwnd_ago_oct_82_16_ina[0,:,:]), cmap='Blues_r', vmin=mi, vmax=md) # [0,:,:] is for the first day of the year
mp.contour(x, y,np.squeeze(uwnd_ago_oct_82_16_ina[0, :, :]), levels=[-9],colors='k', linewidths=0.4,linestyles='solid')
...
plt.savefig('figs/CLLJ-subplots-act-ina.png', dpi=400, bbox_inches='tight')
plt.show()
exit()
